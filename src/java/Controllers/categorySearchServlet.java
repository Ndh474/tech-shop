...
public class categorySearchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        ArrayList<Product> allProducts = dao.getAllProductsByCategoryID(Integer.parseInt(categoryId));
        request.setAttribute("allProducts", allProducts);
        
        ArrayList<Category> allCategories = dao.getAllCategories();
        request.setAttribute("allCategories", allCategories);
        
        ArrayList<Brand> allBrands = dao.getAllBrands();
        request.setAttribute("allBrands", allBrands);
        
        Product lastest = dao.getLastestProduct();
